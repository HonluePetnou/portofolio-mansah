...
export const CircularTestimonials = ({
  ...
  const colorArrowHoverBg = colors.arrowHoverBackground ?? "#5E50F9";
  ...
  // Navigation handlers (defined before autoplay/keyboard so they can be referenced)
        ...
        <div className="flex flex-col justify-between">
          ...
          <div className="flex gap-4 pt-8 md:pt-6">
            <button
              ...
              className="w-11 h-11 rounded-full flex items-center justify-center border-0 cursor-pointer shrink-0"
            >
