          ...
          >
            ...
            <GlassCard className="p-8">
              <div className="flex flex-col gap-2 md:flex-row md:items-center md:justify-between mb-4">
                <div>
                  <h3 className="text-xl font-bold text-foreground">{exp.role[lang]}</h3>
              ...
              <p className="text-muted-foreground dark:text-gray-300 mb-4">{exp.description[lang]}</p>
              <ul className="list-disc list-inside ml-5 space-y-2 text-muted-foreground dark:text-gray-400">
